                        ...
                        <form method="POST" action="{{ route('products.update', $product) }}">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4"><label class="form-label">سعر التكلفة</label><input type="number" name="cost_price" class="form-control" min="0" step="0.01" value="{{ $editModalHasErrors ? old('cost_price') : $product->cost_price }}"></div>
                                    <div class="col-md-4"><label class="form-label">سعر البيع</label><input type="number" name="sell_price" class="form-control" min="0" step="0.01" value="{{ $editModalHasErrors ? old('sell_price') : $product->sell_price }}"></div>
                                    <div class="col-md-4"><label class="form-label">الضريبة %</label><input type="number" name="tax_rate" class="form-control" min="0" max="100" step="0.01" value="{{ $editModalHasErrors ? old('tax_rate') : $product->tax_rate }}"></div>
                                    <div class="col-md-6"><label class="form-label">المخزون الحالي</label><input type="number" name="stock_quantity" class="form-control" min="0" step="0.01" value="{{ $editModalHasErrors ? old('stock_quantity') : $product->stock_quantity }}"></div>
                                    <div class="col-md-6"><label class="form-label">الحد الأدنى للمخزون</label><input type="number" name="min_stock" class="form-control" min="0" step="0.01" value="{{ $editModalHasErrors ? old('min_stock') : $product->min_stock }}"></div>
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('products.store') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4"><label class="form-label">سعر التكلفة</label><input type="number" name="cost_price" class="form-control" min="0" step="0.01" value="{{ old('cost_price', 0) }}"></div>
                        <div class="col-md-4"><label class="form-label">سعر البيع</label><input type="number" name="sell_price" class="form-control" min="0" step="0.01" value="{{ old('sell_price', 0) }}"></div>
                        <div class="col-md-4"><label class="form-label">الضريبة %</label><input type="number" name="tax_rate" class="form-control" min="0" max="100" step="0.01" value="{{ old('tax_rate', 15) }}"></div>
                        <div class="col-md-6"><label class="form-label">المخزون الحالي</label><input type="number" name="stock_quantity" class="form-control" min="0" step="0.01" value="{{ old('stock_quantity', 0) }}"></div>
                        <div class="col-md-6"><label class="form-label">الحد الأدنى للمخزون</label><input type="number" name="min_stock" class="form-control" min="0" step="0.01" value="{{ old('min_stock', 0) }}"></div>
