...
class ChartOfAccountsSynchronizer
{
    private const BASE_DEFINITIONS = [
        ...
        ['code' => '110601', 'name' => 'المخزون - اسم المنتج', 'name_ar' => 'المخزون - اسم المنتج', 'account_type' => 'asset', 'parent' => '1106', 'description' => 'مخزون منتج محدد', 'allows_direct_transactions' => false, 'match_fragments' => ['مخزون', 'منتج']],
